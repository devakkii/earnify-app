...
const HomeScreen = ({ navigation }) => {
  ...
  const [balance] = useState(14); // Code to set balance in wallet screen wallet
      ...
      case "Prime Offer":
        return (
          <PrimeOfferScreen
            ...
            setIsPrimeWithdrawn={setIsPrimeWithdrawn}
          />
        );
        ...
        <ScrollView style={styles.mainContent}>
          ...
          <View style={styles.section1}>
            ...
            <TouchableOpacity style={styles.dailyCheckin} onPress={toggleModal}>
              <Image
                source={require("../../assets/daily-checkin.jpg")}
            ...
            <TouchableOpacity
              ...
              onPress={() => alert("Watch Video Reward!")}
            >
              <Image
                source={require("../../assets/videorewards.jpg")}
                style={styles.sectionLogo}
              />
          ...
          <View style={styles.section3}>
            <Text style={styles.comingSoonText}>
              More earning ways are coming soon!
            </Text>
          </View>
        </ScrollView>
      ) : (
